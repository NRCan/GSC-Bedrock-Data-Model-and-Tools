...
{
    public class Button_Legend_Export : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public Button_Legend_Export()
        {
            //Init culture
        ...
        protected override void OnClick()
        {
            ...
            if (Properties.Settings.Default.dwEnabling)
            {
                ...
                if (isProjectValid)
                {
                    ...
                    Form_Legend_Export exportLegendForm = new Form_Legend_Export();
                    exportLegendForm.Show();
                }
