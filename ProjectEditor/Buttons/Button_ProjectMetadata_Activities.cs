...
{
    public class Button_ProjectMetadata_Activities : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public Button_ProjectMetadata_Activities()
        {
            //Init culture
        ...
        protected override void OnClick()
        {
            ...
            if (Properties.Settings.Default.dwEnabling)
            {
                ...
                if (isProjectValid)
                {
                    ...
                    Form_ProjectMetadata_Activities addActivityForm = new Form_ProjectMetadata_Activities();
