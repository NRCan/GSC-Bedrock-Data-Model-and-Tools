...
{
    public class Button_ProjectMetadata_Organization : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public Button_ProjectMetadata_Organization()
        {
            //Init culture
        ...
        protected override void OnClick()
        {
            ...
            if (Properties.Settings.Default.dwEnabling)
            {
                ...
                if (isProjectValid)
                {
                    ...
                    Form_ProjectMetadata_Organization addOrgForm = new Form_ProjectMetadata_Organization();
                    addOrgForm.Show();
                }
